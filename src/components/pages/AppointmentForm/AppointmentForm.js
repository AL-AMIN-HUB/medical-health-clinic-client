          ...
          <Card className="h-100 border-0 ">
            <Card.Body>
              ...
              <form onSubmit={handleSubmit} action="#">
                <input placeholder="Department" className="form-control my-2 py-2 px-3" type="text" name="department" />

                <input placeholder="Appointment Date" className="form-control my-3 py-3 px-3" type="date" name="date" />
                <input placeholder="Enter Your Name*" required className="form-control my-3 py-3 px-3" type="text" name="userName" />
                <input placeholder="Enter Your Email*" required className="form-control my-3 py-3 px-3" type="email" name="email" />
